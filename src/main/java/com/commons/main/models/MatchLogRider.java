...
public class MatchLogRider {
	...
	private double driverSourceLat;
	private double driverSourceLon;
	...
	public double getDriverSourceLat() {
		return driverSourceLat;
	}

	public void setDriverSourceLat(double driverSourceLat) {
		this.driverSourceLat = driverSourceLat;
	}

	public double getDriverSourceLon() {
		return driverSourceLon;
	}

	public void setDriverSourceLon(double driverSourceLon) {
		this.driverSourceLon = driverSourceLon;
	}
